      ...
      '<footer class="op-footer">',
        '<div class="op-footer__top">',
          ...
          '<div class="op-footer__col">',
            ...
            '<a href="https://instagram.com/gimmemwah" class="op-footer__link" aria-label="Instagram (opens in new tab)" target="_blank" rel="noopener noreferrer" data-analytics-platform="instagram" data-analytics-location="footer">INSTAGRAM</a>',
            '<a href="https://x.com/gimmemwah" class="op-footer__link" aria-label="X (opens in new tab)" target="_blank" rel="noopener noreferrer" data-analytics-platform="x" data-analytics-location="footer">X</a>',
            '<a href="https://www.tiktok.com/@gimmemwah" class="op-footer__link" aria-label="TikTok (opens in new tab)" target="_blank" rel="noopener noreferrer" data-analytics-platform="tiktok" data-analytics-location="footer">TIKTOK</a>',
          '</div>',
        '</div>',
